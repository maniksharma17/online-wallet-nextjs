...
export const SigninPage = () => {
  ...
  return <div className="">
      ...
      <div 
       className="flex flex-col gap-5 m-auto mt-28 min-w-3/12 w-4/12 p-5 rounded-lg shadow-lg bg-white ">
