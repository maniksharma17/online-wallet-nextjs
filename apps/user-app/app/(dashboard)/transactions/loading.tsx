export default function Loading(){
    return <div className="w-1/2 mt-36 m-auto">
    ...
    <div role="status"  className="w-full p-4 space-y-4 mt-10 m-auto divide-y divide-gray-200 rounded shadow animate-pulse">
        <div  className="flex items-center justify-between">
            <div>
                <div  className="h-2.5 bg-gray-300 rounded-full w-full mb-2.5"></div>
                <div  className="w-32 h-2 bg-gray-200 rounded-full  "></div>
