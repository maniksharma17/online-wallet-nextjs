  ...
  return (
    <div>
      <div className="relative mt-28">
        <div className="flex flex-col gap-2 bg-blue-200 h-[80vh] w-9/12 ml-24 rounded-3xl mt-8 relative">
          <p className="font-thin text-9xl ml-5 mb-0 text-blue-900 z-40">Fast,<br></br>Safe, Social,<br></br>Payments.</p>
          <p className="z-50 mt-5 w-1/3 ml-5 font-thin text-2xl text-left text-black">Pay, get paid, grow a business, and more. Join the tens of millions of people on PayZap.</p>
          <Link href={'/signup'}>
